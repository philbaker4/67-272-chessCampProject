namespace :db do
  ...
  task :populate => :environment do
    ...
    dates = [[Date.new(2018,7,11),Date.new(2018,7,15)],
             [Date.new(2018,7,18),Date.new(2018,7,22)],
             [Date.new(2018,7,25),Date.new(2018,7,29)],
             [Date.new(2018,8,9),Date.new(2018,8,13)],
             [Date.new(2018,8,16),Date.new(2018,8,20)],
             [Date.new(2018,8,23),Date.new(2018,8,27)],
             [Date.new(2018,9,30),Date.new(2018,10,3)],
             [Date.new(2018,9,6),Date.new(2018,9,10)],
             [Date.new(2018,9,13),Date.new(2018,9,17)],
             [Date.new(2018,9,20),Date.new(2018,9,24)]]
